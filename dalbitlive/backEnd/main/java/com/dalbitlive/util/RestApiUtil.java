...
//import com.dalbitlive.common.service.CommonService;
//import com.dalbitlive.common.vo.procedure.P_ErrorLogVo;
...
public class RestApiUtil {
    ...
    public static String sendSocketPost(String strUrl, String authToken, String roomNo, String params){
        ...
        try {
            ...
            String desc = "";
            if (!com.dalbitlive.util.DalbitUtil.isEmpty(params)) {
                desc = "Data : \n" + params + "\n";
            }
